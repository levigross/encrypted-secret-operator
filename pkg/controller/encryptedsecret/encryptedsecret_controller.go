...
import (
	...
	secretv1alpha1 "github.com/levigross/encrypted-secret-operator/pkg/apis/secret/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &secretv1alpha1.EncryptedSecret{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &secretv1alpha1.EncryptedSecret{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileEncryptedSecret) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &secretv1alpha1.EncryptedSecret{}
...
func newPodForCR(cr *secretv1alpha1.EncryptedSecret) *corev1.Pod {
